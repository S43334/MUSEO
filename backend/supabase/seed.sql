...
values
  ...
  ('fantasia', 'FantasÃ­a y color', '#355f4a', 2, true),
  ('pop', 'Cultura pop y hÃ©roes', '#6a3f56', 3, true),
  ('tradicion', 'TradiciÃ³n, fe y estudio', '#6b5a32', 4, true)
...
insert into public.rooms (slug, title, color, sort_order, is_published)
values ('fantasia', 'FantasÃ­a y color', '#355f4a', 2, true)
on conflict (slug) do update
set title = excluded.title,
    color = excluded.color,
    sort_order = excluded.sort_order,
...
insert into public.rooms (slug, title, color, sort_order, is_published)
values ('pop', 'Cultura pop y hÃ©roes', '#6a3f56', 3, true)
on conflict (slug) do update
set title = excluded.title,
    color = excluded.color,
    sort_order = excluded.sort_order,
...
insert into public.rooms (slug, title, color, sort_order, is_published)
values ('tradicion', 'TradiciÃ³n, fe y estudio', '#6b5a32', 4, true)
on conflict (slug) do update
set title = excluded.title,
    color = excluded.color,
    sort_order = excluded.sort_order,
...
values (
  ...
  'SebastiÃ¡n',
  'Dinorah Isabella DomÃ­nguez Ruiz',
  'Sin fecha',
  'Grafito y color',
  'Parte de una colecciÃ³n personal creada con dedicaciÃ³n y amor.',
  'retratos',
  'fantasia_luminosa',
  1,
  true
...
values (
  ...
  'La reina de los pÃ¡jaros canta...',
  'Dinorah Isabella DomÃ­nguez Ruiz',
  'Sin fecha',
  'Grafito y color',
  'Parte de una colecciÃ³n personal creada con dedicaciÃ³n y amor.',
...
values (
  24,
  (select id from public.rooms where slug = 'pop'),
  'Los hÃ©roes tambiÃ©n toman leche',
  'Dinorah Isabella DomÃ­nguez Ruiz',
  'Sin fecha',
  'Grafito y color',
  'Parte de una colecciÃ³n personal creada con dedicaciÃ³n y amor.',
